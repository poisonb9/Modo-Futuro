...
orig = (precos.CATALOGO, precos.AGORA, precos.SERIE, precos.puxar, mercadolivre.preco_atual)
try:
    ...
    mercadolivre.preco_atual = lambda ids: {"MLB1": 200.0, "MLB2": 70.0}
    ...
    mercadolivre.preco_atual = lambda ids: {"MLB1": 189.9, "MLB2": 70.0}
    precos.atualizar()
    ...
    checar(len(precos.SERIE.read_text(encoding="utf-8").splitlines()) == 3, "e a serie nao ganhou ponto falso")
finally:
    precos.CATALOGO, precos.AGORA, precos.SERIE, precos.puxar, mercadolivre.preco_atual = orig
