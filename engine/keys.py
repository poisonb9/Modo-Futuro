...
class Rotador:
    ...
    def __init__(self, prefixo: str):
        ...
        # ⚠️ O TETO E' QUANTOS SLOTS O RODIZIO ENXERGA, e ele ja' cortou
        # chave viva: em 31/08/2026 os pools dos dois motores foram
        # unificados (ordem do Bryan, "todas rodam para todos") e a cozinha
        # passou a ter o slot 21 — que `range(2, 21)` NAO lia. A chave
        # existia no repositorio, aparecia na listagem de secrets, e nunca
        # entrava no rodizio.
        #
